...
sap.ui.define(
  [
    ...
    "nucleus/mainConfig/libs/filesaver",
    "nucleus/mainConfig/libs/xlsx.full.min",
  ],
  function (ManagedObject, XlsxFullmin) {
    "use strict";

    return ManagedObject.extend("nucleus.mainConfig.utils.XlsxUtils", {
      ...
      /* ===========================================================
       Descargar Template
      ============================================================= */
      getTemplate: function (xlsxHeaders, oXlsxTemp) {
        ...
        this.onSaveAsExcel(excelBuffer, "create plant Template");
      },
